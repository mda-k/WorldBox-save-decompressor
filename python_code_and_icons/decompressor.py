...
root = ctk.CTk()
root.title("worldbox save decompressor")
root.geometry("500x340")
messagebox.showerror("ATTENTION!", """THIS PYTHON SCRIPT WILL INFACT OVERWRITE FILES WITH SAME NAMES, SO PLEASE MAKE A NEW FOLDER, AND PUT IN ONLY THE .wbox SAVE YOU WANT TO UNCOMPRESS THERE!
